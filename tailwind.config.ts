  ...
  theme: {
  	...
  	extend: {
  		...
  		backgroundImage: {
  			...
  			'contact-banner': `url('/images/contact-banner.jpg')`,
  			'about-banner': `url('/images/about-banner.jpg')`,
  			'contact-form-paper': `url('/images/contact-form-paper.jpg')`,
  			footer: `url('https://res.cloudinary.com/dzl5ur69n/image/upload/v1728650985/fyvykb7kphju47xee51a.jpg')`,
